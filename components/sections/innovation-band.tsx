...
export function InnovationBand() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-16">
      <ScrollReveal>
        <div
          className="relative overflow-hidden rounded-xl2 border border-ink/10 px-8 py-12 text-center md:px-14 md:py-14"
          style={{
            background:
        ...
        >
          <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-ink/10 bg-ink/5 px-4 py-1.5 text-sm font-semibold text-ink/70">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-ink-soft lg:text-lg">

    ...
    <section className="mx-auto max-w-6xl px-6 py-24" aria-label="Sık kurduğumuz otomasyonlar">
      <ScrollReveal>
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-ink-soft lg:text-lg">
        ...
        {AUTOMATIONS.map((item, i) => {
          ...
          return (
            <ScrollReveal key={item.title} delay={i * 0.05}>
              <div className="glass flex items-start gap-3.5 rounded-xl border border-ink/10 p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_32px_-10px_#06B6D4]">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-ink/10 bg-ink/5 text-[#06B6D4]">
